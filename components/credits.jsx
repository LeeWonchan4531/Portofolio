        ...
        <div data-section id='credits' className='group mt-32'>
            <div className='text-surface-600'>
                ...
                <div className='flex flex-row justify-between'>
                    <a href="https://status.jeonnam.school/" rel="noopener noreferrer" className="scroll-auto transition-all hover:text-on-background">Server Status</a>
                    <a href="https://idc.jeonnam.school/" rel="noopener noreferrer" className="scroll-auto transition-all hover:text-on-background">Mirror Server</a>
                    <span>{props.data.name} | {currentYear}</span>
                </div>
            </div>
        </div>
    )
